...
const PengadaanDelete = props => {
	...
	const handleSubmit = event => {
		...
		ComponentService.deletePengadaanPost(id).then(response => setOpenModal(true))
...
PengadaanDelete.propTypes = {
	className: PropTypes.string
};

export default PengadaanDelete;
